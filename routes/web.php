...
Route::middleware(["auth"])->group(function () {
    ...
    Route::post("projects/{project}/switch", [App\Http\Controllers\ProjectController::class, "switch"])->name(
        "projects.switch",
    );
    Route::post("projects/{project}/sync-github", [App\Http\Controllers\ProjectController::class, "syncGithub"])->name(
    ...
    Route::middleware(["team.project"])->group(function () {
        ...
        Route::get("projects/{project}/backlog", [App\Http\Controllers\BacklogController::class, "index"])->name(
            "projects.backlog.index",
        );
        Route::post("projects/{project}/backlog", [App\Http\Controllers\BacklogController::class, "store"])->name(
            "projects.backlog.store",
        );
        Route::put("projects/{project}/backlog/{task}", [
            App\Http\Controllers\BacklogController::class,
            "update",
        ])->name("projects.backlog.update");
        Route::delete("projects/{project}/backlog/{task}", [
            App\Http\Controllers\BacklogController::class,
            "destroy",
        ])->name("projects.backlog.destroy");
        Route::post("projects/{project}/backlog/reorder", [
            App\Http\Controllers\BacklogController::class,
            "reorder",
        ])->name("projects.backlog.reorder");
        Route::post("projects/{project}/backlog/{task}/move-up", [
            App\Http\Controllers\BacklogController::class,
            "moveUp",
        ])->name("projects.backlog.move-up");
        Route::post("projects/{project}/backlog/{task}/move-down", [
            App\Http\Controllers\BacklogController::class,
            "moveDown",
        ])->name("projects.backlog.move-down");
        Route::post("projects/{project}/backlog/{task}/subtasks", [
            App\Http\Controllers\BacklogController::class,
            "createSubtasks",
        ...
        Route::get("projects/{project}/sprints/{sprint}/tasks", [
            App\Http\Controllers\TaskController::class,
            "index",
        ])->name("projects.sprints.tasks.index");
        Route::post("projects/{project}/sprints/{sprint}/tasks", [
            App\Http\Controllers\TaskController::class,
            "store",
        ])->name("projects.sprints.tasks.store");
        Route::put("projects/{project}/sprints/{sprint}/tasks/{task}", [
            App\Http\Controllers\TaskController::class,
            "update",
        ])->name("projects.sprints.tasks.update");
        Route::post("projects/{project}/sprints/{sprint}/tasks/reorder", [
            App\Http\Controllers\TaskController::class,
            "reorder",
        ...
        Route::post("projects/{project}/sprints/{sprint}/tasks/{task}/move-to-backlog", [
            App\Http\Controllers\TaskController::class,
            "moveToBacklog",
        ])->name("projects.sprints.tasks.move-to-backlog");

        Route::get("projects/{project}/tasks/{task}/comments", [
            App\Http\Controllers\TaskCommentController::class,
            "index",
        ])->name("projects.tasks.comments.index");
        Route::post("projects/{project}/tasks/{task}/comments", [
            App\Http\Controllers\TaskCommentController::class,
            "store",
        ])->name("projects.tasks.comments.store");
        Route::put("projects/{project}/tasks/{task}/comments/{comment}", [
            App\Http\Controllers\TaskCommentController::class,
            "update",
        ...
        Route::get("projects/{project}/sprints/{sprint}/retrospective", [
            App\Http\Controllers\RetrospectiveController::class,
            "show",
        ])->name("projects.sprints.retrospective.show");
        Route::post("projects/{project}/sprints/{sprint}/retrospective", [
            App\Http\Controllers\RetrospectiveController::class,
            "store",
        ])->name("projects.sprints.retrospective.store");
        Route::put("projects/{project}/sprints/{sprint}/retrospective/{retrospective}", [
            App\Http\Controllers\RetrospectiveController::class,
            "update",
        ])->name("projects.sprints.retrospective.update");
        Route::post("retrospectives/{retrospective}/vote", [
            App\Http\Controllers\RetrospectiveController::class,
            "vote",
        ])->name("retrospectives.vote");
        ...
        Route::get("projects/{project}/documents", [App\Http\Controllers\DocumentController::class, "index"])->name(
            "projects.documents.index",
        );
        Route::post("projects/{project}/documents", [App\Http\Controllers\DocumentController::class, "store"])->name(
            "projects.documents.store",
        );
        Route::put("projects/{project}/documents/{document}", [
            App\Http\Controllers\DocumentController::class,
            "update",
        ])->name("projects.documents.update");
        Route::delete("projects/{project}/documents/{document}", [
            App\Http\Controllers\DocumentController::class,
            "destroy",
    ...
    Route::post("teams/{team}/members", [App\Http\Controllers\TeamController::class, "addMember"])->name(
        "teams.members.add",
    );
    Route::delete("teams/{team}/members/{user}", [App\Http\Controllers\TeamController::class, "removeMember"])->name(
        "teams.members.remove",
    );
    Route::put("teams/{team}/members/{user}/role", [App\Http\Controllers\TeamController::class, "updateRole"])->name(
